...
namespace Productivity.UnitTests.Extensions.Validation
{
    [TestFixture]
    public class ValidationTests
    {
        ...
        [Test]
        public void HasProps_ValidSourceTarget_PropsMatch()
        {
            var src = new SimpleMan();

            bool isMatch = src.HasProps<SimpleMan>();

            Assert.True(isMatch);
        }

        [Test]
        public void HasProps_ValidSourceTarget_PropsDontMatch()
        {
            var src = new SimpleMan();

            bool isMatch = src.HasProps<ComplexFake>();
